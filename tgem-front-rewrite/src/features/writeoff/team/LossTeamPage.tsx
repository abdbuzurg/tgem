...
export default function LossTeamPage() {
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => queryClient.invalidateQueries(["invoice-writeoff", "loss-team"]),
  })
  ...
  return (
    <main>
      ...
      <table className="table-auto text-sm text-left mt-2 w-full border-box">
        <thead className="shadow-md border-t-2">
          <tr>
            ...
            <th className="px-4 py-3"><span>Бригада</span></th>
      ...
      {showAddModal && <WriteoffMutationModal mode="create" locationKind="team" writeOffType="loss-team" setShowModal={setShowAddModal} />}
      {showEditModal &&
        <WriteoffMutationModal mode="edit" locationKind="team" writeOffType="loss-team" setShowModal={setShowEditModal} invoiceWriteOff={rowToEdit!} />
      }
