...
import InvoiceReturnTeamMutationModal from "./InvoiceReturnTeamMutationModal"
...
export default function InvoiceReturnTeam() {
  ...
  return (
    <main>
      ...
      {showAddModal && <InvoiceReturnTeamMutationModal mode="create" setShowModal={setShowAddModal} />}
      {showEditModal && <InvoiceReturnTeamMutationModal mode="edit" setShowModal={setShowEditModal} invoiceReturnTeam={rowToEdit!} />}
